...
class IncomeDataPort(object):
    ...
    def _report_range_min(self, min_date):
        ...
        return dt(start_date.year - 6, 9, 30).strftime('%Y%m%d')
...
if __name__ == '__main__':
    ...
    income_statement.raw(['000001.SZ', '000002.SZ'], ['20140430','20170707'], 'net_income', factor_method='ttm')
